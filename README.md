...
I am open to academic collaborations and please drop me an email if you are interested in collaborating with me. I am looking for an opportunity to **work as an intern** with a **24Fall** admissions professor.
...
<br>*I didn't submit AAAI because I thought its template was ugly. First ASLP Baseline and First dual-condition diffusion for Sign Language.*
...
<br>*The ACL review was that it would require minor revisions to get published, perhaps to arouse some community interest. There was no suitable meeting before the application, so I had to hand it over to the seminar.*
...
+ [Chunyu Sui](https://github.com/Capsfly)
